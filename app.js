...
function randomColors(){
    ...
    colorDivs.forEach((div,index) =>{
        ...
        const randomColor = generateHax();
        //Add it to the initial array
...
//Implement save to palette and local stroage stuff
...
function savePalette(e) {
  ...
  if (paletteObjects) {
    ...
    saveInput.value = "";
    //generate the palette fot Library
